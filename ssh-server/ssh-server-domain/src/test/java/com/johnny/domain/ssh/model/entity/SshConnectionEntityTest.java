...
public class SshConnectionEntityTest {
    ...
    public void create_valid_password_auth() {
        SshConnectionEntity e = SshConnectionEntity.create(
                ...
                "root", AuthTypeVO.PASSWORD, "pwd", null, "user_001");
        assertEquals("cid", e.getConnectionId());
        assertEquals("我的服务器", e.getName());
        assertEquals(ConnectionStatusVO.DISCONNECTED, e.getStatus());
    }
    ...
    public void create_valid_publickey_auth() {
        SshConnectionEntity e = SshConnectionEntity.create(
                ...
                "ubuntu", AuthTypeVO.PUBLIC_KEY, null, "-----BEGIN PRIVATE KEY-----", "u");
        assertEquals(AuthTypeVO.PUBLIC_KEY, e.getAuthType());
    }

    @Test(expected = AppException.class)
    public void validate_blank_name() {
        SshConnectionEntity.create("cid", "   ", "h", 22, "u", AuthTypeVO.PASSWORD, "p", null, "u");
    }

    @Test(expected = AppException.class)
    public void validate_name_too_long() {
        SshConnectionEntity.create("cid", "a".repeat(65), "h", 22, "u", AuthTypeVO.PASSWORD, "p", null, "u");
    }

    @Test(expected = AppException.class)
    public void validate_blank_host() {
        SshConnectionEntity.create("cid", "n", "  ", 22, "u", AuthTypeVO.PASSWORD, "p", null, "u");
    }

    @Test(expected = AppException.class)
    public void validate_invalid_port_zero() {
        SshConnectionEntity.create("cid", "n", "h", 0, "u", AuthTypeVO.PASSWORD, "p", null, "u");
    }

    @Test(expected = AppException.class)
    public void validate_invalid_port_too_large() {
        SshConnectionEntity.create("cid", "n", "h", 70000, "u", AuthTypeVO.PASSWORD, "p", null, "u");
    }

    @Test(expected = AppException.class)
    public void validate_blank_username() {
        SshConnectionEntity.create("cid", "n", "h", 22, "", AuthTypeVO.PASSWORD, "p", null, "u");
    }
    ...
    public void validate_password_auth_missing_password() {
        SshConnectionEntity.create("cid", "n", "h", 22, "u", AuthTypeVO.PASSWORD, "", null, "u");
    }

    @Test(expected = AppException.class)
    public void validate_publickey_auth_missing_key() {
        SshConnectionEntity.create("cid", "n", "h", 22, "u", AuthTypeVO.PUBLIC_KEY, null, "", "u");
    }

    @Test
    public void mark_connected_changes_status() {
        SshConnectionEntity e = SshConnectionEntity.create(
                "cid", "n", "h", 22, "u", AuthTypeVO.PASSWORD, "p", null, "u");
        e.markConnected();
        assertEquals(ConnectionStatusVO.CONNECTED, e.getStatus());
        e.markDisconnected();
        assertEquals(ConnectionStatusVO.DISCONNECTED, e.getStatus());
    }
}
